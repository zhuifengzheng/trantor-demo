 ...
 * @create 2020-07-08 11:18 上午
 **/
@Slf4j
@Component
@RequiredArgsConstructor
public class MDShopMultiAction implements MultiDataAction<MDShopVO> {
    ...
    public MultiDataResult<MDShopVO> load(MultiDataParams multiDataParams) {
        ...
        return new MultiDataResult<>(MDShopConverter.converter(pageData.getData()), 10L);
    }
