...
public class B2cMDMerchantShopMultiAction implements MultiDataAction<B2cMDShopVO> {
    private final MDShopReadFacade readFacade;
    private final MDEnterpriseUserReadFacade enterpriseUserReadFacade;

    @Override
    public MultiDataResult<B2cMDShopVO> load(MultiDataParams multiDataParams) {
...
//        Paging<MDShopFullInfo> pageData = getRes.getResult();
        ...
        Paging<MDShopFullInfo> pageData = getRes.getResult();
        return new MultiDataResult<>(MDShopConverter.converterB2c(pageData.getData()), pageData.getTotal());
    }
    ...
    private List<MDShopFullInfo> getMdShopFullInfo(){
        ...
        info1.setChannelInfo(mdChannelInfo);
        ...
        info2.setLatitude("");
        info2.setShopType("");
        MDChannelInfo mdChannelInfo2 = new MDChannelInfo();
        mdChannelInfo2.setType("OFFONLINE");
        info1.setChannelInfo(mdChannelInfo2);
