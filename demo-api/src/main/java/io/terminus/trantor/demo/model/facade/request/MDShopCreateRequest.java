...
public class MDShopCreateRequest extends MasterDataAbstractRequest {
    ...
    public OperationType getOperationType() {
        return ShopOperationType.SHOP_CREATE;
    }
    ...
    public void checkParam() {
        ...
        ParamUtil.nonNull(name, "MDCreateShopRequest.nameCannotBeNull");
        ParamUtil.nonNull(relegationEnterpriseId, "MDCreateShopRequest.relegationEnterpriseIdCannotBeNull");
        ParamUtil.nonNull(address, "MDCreateShopRequest.addressCannotBeNull");
    }
}
